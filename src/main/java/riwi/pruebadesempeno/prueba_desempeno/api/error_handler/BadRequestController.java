package riwi.pruebadesempeno.prueba_desempeno.api.error_handler;
...
import riwi.pruebadesempeno.prueba_desempeno.api.dto.errors.BaseErrorResp;
import riwi.pruebadesempeno.prueba_desempeno.api.dto.errors.ErrorsResp;
...
public class BadRequestController {
    ...
    @ExceptionHandler(riwi.pruebadesempeno.prueba_desempeno.utils.exceptions.BadRequestException.class)
    public riwi.pruebadesempeno.prueba_desempeno.api.dto.errors.BaseErrorResp handleError(BadRequestException exception){
        List<Map<String,String>> errors = new ArrayList<>();
